...
BUILDIN_FUNC(getcostumeitem)
{
	...
	if (data_isstring(data)) {
		...
		std::shared_ptr<item_data> item_data_shared = item_db.searchname(name);
		struct item_data *item_data = item_data_shared.get();
...
// <--- [zBuffer] List of unit control commands
	...
	BUILDIN_DEF(costume, "i"), // costconv
	BUILDIN_DEF(getcostumeitem, "v"), // costconv
